...
from models.baseline6_net import Baseline6Network
...
if __name__ == "__main__":
    ...
    folder_name = f"Baseline6_SID_CDFA_Loss_CR_SADecoder_{dataset_name}_{val_name}_lr{lr_decoder}_{current_time}"
    ...
    # 实例化带有辅助预测输出的 Baseline6Network
    model = Baseline6Network()
