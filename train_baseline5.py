...
from models.baseline5_net import Baseline5Network
...
if __name__ == "__main__":
    ...
    folder_name = f"Baseline5_SID_CDFA_Loss_CR_{dataset_name}_{val_name}_lr{lr_decoder}_{current_time}"
    ...
    # 实例化带有辅助预测输出的 Baseline5Network
    model = Baseline5Network()
